...
export const handleCheckboxChange = (
  ...
  if (value === allProperties) {
    ...
    newValue = e.target.checked ? [allProperties] : [];
  } else {
    ...
    if (newValue.includes(allProperties) && e.target.checked) {
      newValue = newValue.filter((val) => val !== allProperties);
    }
  }
  ...
  setFilters((prevFilters) => ({
    ...prevFilters,
    [value]: newValue, // Update the specific property type in the filters
  }));
