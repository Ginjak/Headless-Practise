...
export default function Property({ property }) {
  ...
  return (
    <Link
      ...
      className="rounded-xl xs:border-[1px] xs:border-property-txt-700/10 xs:shadow-md"
    >
        ...
        <div className="p-4 flex flex-col justify-between grow">
          <div>
            <div className="flex justify-between mb-2">
              <p className="text-property-txt-700 text-lg font-bold tracking-wide">
                £
                {property?.original_price &&
                  new Intl.NumberFormat().format(property?.original_price)}
              </p>
              <p className="text-property-txt-700">
                {property?.property_type?.charAt(0).toUpperCase() +
                  property?.property_type?.slice(1)}
              </p>
            </div>
            <p className="text-property-txt-700 tracking-wide mb-4">
                ...
                <div className="flex justify-between w-full">
                  ...
                  <div className="flex items-center gap-3">
                    <Link
                      ...
                      className="p-2 bg-property-acc-100 hover:bg-property-acc-300 rounded-lg text-white transition-colors duration-300"
                    >
                      <FaPhone />
                    </Link>
                    <Link
